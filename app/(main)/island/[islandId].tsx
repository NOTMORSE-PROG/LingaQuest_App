  ...
  return (
    <>
      <Svg width={w} height={h} style={{ position: "absolute", top: 0, left: 0 }}>
        ...
        <Path
          d={`M0,${h*0.45} L${w*0.05},${h*0.30} L${w*0.10},${h*0.22} L${w*0.14},${h*0.27} L${w*0.18},${h*0.18} L${w*0.23},${h*0.25} L${w*0.28},${h*0.20} L${w*0.34},${h*0.28} L${w*0.40},${h*0.22} L${w*0.46},${h*0.30} L${w*0.52},${h*0.20} L${w*0.58},${h*0.26} L${w*0.64},${h*0.19} L${w*0.70},${h*0.27} L${w*0.76},${h*0.22} L${w*0.82},${h*0.30} L${w*0.88},${h*0.25} L${w*0.94},${h*0.33} Lw,${h*0.45} Z`}
        ...
        {/* Range 2 — mid-back */}
        <Path
          d={`M0,${h*0.52} L${w*0.06},${h*0.40} L${w*0.12},${h*0.32} L${w*0.18},${h*0.38} L${w*0.24},${h*0.30} L${w*0.30},${h*0.36} L${w*0.36},${h*0.28} L${w*0.42},${h*0.35} L${w*0.48},${h*0.30} L${w*0.54},${h*0.38} L${w*0.60},${h*0.29} L${w*0.66},${h*0.36} L${w*0.72},${h*0.31} L${w*0.78},${h*0.38} L${w*0.84},${h*0.33} L${w*0.90},${h*0.40} Lw,${h*0.52} Z`}
          fill="rgba(25,6,6,0.45)"
        />
        {/* Range 3 — mid-front */}
        <Path
          d={`M0,${h*0.58} L${w*0.08},${h*0.46} L${w*0.15},${h*0.40} L${w*0.22},${h*0.46} L${w*0.30},${h*0.38} L${w*0.38},${h*0.44} L${w*0.45},${h*0.36} L${w*0.52},${h*0.43} L${w*0.60},${h*0.38} L${w*0.67},${h*0.44} L${w*0.74},${h*0.39} L${w*0.82},${h*0.46} L${w*0.90},${h*0.41} Lw,${h*0.58} Z`}
          fill="rgba(20,5,5,0.52)"
        />
        {/* Range 4 — closest foreground rock */}
        <Path
          d={`M0,${h*0.66} L${w*0.06},${h*0.52} L${w*0.14},${h*0.48} L${w*0.20},${h*0.54} L${w*0.28},${h*0.46} L${w*0.36},${h*0.52} L${w*0.44},${h*0.47} L${w*0.52},${h*0.54} L${w*0.60},${h*0.48} L${w*0.68},${h*0.54} L${w*0.76},${h*0.49} L${w*0.84},${h*0.55} L${w*0.92},${h*0.50} Lw,${h*0.66} Z`}
  ...
  return (
    <>
      <Svg width={w} height={h} style={{ position: "absolute", top: 0, left: 0 }}>
        ...
        <Path
          d={`M0,${h*0.55} L${w*0.08},${h*0.42} L${w*0.16},${h*0.38} L${w*0.24},${h*0.44} L${w*0.32},${h*0.36} L${w*0.40},${h*0.42} L${w*0.50},${h*0.35} L${w*0.60},${h*0.41} L${w*0.68},${h*0.36} L${w*0.75},${h*0.43} L${w*0.83},${h*0.38} Lw,${h*0.55} Z`}
          fill="rgba(35,15,0,0.38)"
        />
        {/* Range 2 — mid */}
        <Path
          d={`M0,${h*0.60} L${w*0.06},${h*0.48} L${w*0.14},${h*0.44} L${w*0.22},${h*0.50} L${w*0.30},${h*0.44} L${w*0.38},${h*0.50} L${w*0.46},${h*0.45} L${w*0.55},${h*0.51} L${w*0.63},${h*0.46} L${w*0.72},${h*0.52} L${w*0.80},${h*0.47} L${w*0.90},${h*0.54} Lw,${h*0.60} Z`}
          fill="rgba(28,12,0,0.45)"
        />
        {/* Range 3 — front dock */}
        <Path
          d={`M0,${h*0.68} L${w*0.08},${h*0.55} L${w*0.18},${h*0.52} L${w*0.28},${h*0.56} L${w*0.38},${h*0.52} L${w*0.48},${h*0.57} L${w*0.58},${h*0.53} L${w*0.68},${h*0.58} L${w*0.78},${h*0.54} L${w*0.88},${h*0.59} Lw,${h*0.68} Z`}
